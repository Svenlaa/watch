<x-app-layout class="max-w-7xl flex-col mx-auto px-4 relative items-center flex sm:flex-row gap-4">
    <div
        class="flex-none w-full sticky top-0 h-min bg-white sm:w-64 flex flex-col items-center rounded-b-md drop-shadow-md">
